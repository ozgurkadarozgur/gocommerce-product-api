...
// NotFoundError returns when trying to fetch a specific presenter and it was not found in the database.
...
// NotSingularError returns when trying to fetch a singular presenter and more then one was found in the database.
