...
// CategoryUpdateOne is the builder for updating a single Category presenter.
...
// Save executes the query and returns the updated presenter.
...
// Exec executes the query on the presenter.
