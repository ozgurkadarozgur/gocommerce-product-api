...
// First returns the first Category presenter in the query. Returns *NotFoundError when no category was found.
...
// Only returns the only Category presenter in the query, returns an error if not exactly one presenter was returned.
